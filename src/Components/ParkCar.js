...
//  let  results = this.state.allTask.filter(task =>  task.summary.toLowerCase().includes(this.state.searchText))
...
searchData=(e)=>{
  let arr= this.state.refereshed_details.filter(a=>a.color.toLowerCase().includes(this.state.SearchItem))
   this.setState({
     refereshed_details:this.state.refereshed_details.filter(a=>a.color.toLowerCase().includes(this.state.SearchItem))
   })
}
submitData = (e) => {
  var Parked_car_detail = JSON.parse(localStorage.getItem("car_parked"));
...
console.log("in if ")
    ...
    localStorage.setItem("car_parked", JSON.stringify(Parked_car_detail));
    var Parked_car_detail_u = JSON.parse(localStorage.getItem("car_parked"));
    this.setState({
...
console.log("in else if ")
 ...
 let cnt =true;
for(let i = 0 ; i < Parked_car_detail.length;i++){
        ...
        <div className="container">
          ...
          <div class="table-container mt-5 mb-5 w-75 mx-auto">
            ...
            <table class="table table-striped shadow ">
              ...
              <tbody>{this.renderCarParkedDeatil()}</tbody>
            </table>
          </div>
